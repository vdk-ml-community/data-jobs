...
def run(job_input: IJobInput):
    ...
    if len(df_covid) > 0:
        job_input.send_tabular_data_for_ingestion(
            ...
            destination_table=f"{props['prefix']}_covid_cases_usa_daily" # <- !!! ENTER BETWEEN THE QUOTATION MARKS THE NAME OF THE TABLE CREATED IN SCRIPT 01_create_covid_cases_usa_daily.sql) !!!
        )
