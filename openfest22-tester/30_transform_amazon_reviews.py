...
def run(job_input: IJobInput):
    ...
    if len(df) > 0:
        ...
        job_input.send_tabular_data_for_ingestion(
            ...
            destination_table=f"{props['prefix']}_yankee_candle_reviews_transformed" # <- !!! ENTER BETWEEN THE QUOTES THE NAME OF THE TABLE WE CREATED IN SCRIPT "03_create_yankee_candle_reviews_transformed.sql" !!!
        )
