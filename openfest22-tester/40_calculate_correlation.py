...
def run(job_input: IJobInput):
    ...
    if len(df_merged_weekly) > 0:
        ...
        job_input.send_tabular_data_for_ingestion(
            ...
            destination_table=f"{props['prefix']}_weekly_correlation" # <- !!! ENTER BETWEEN THE QUOTES THE NAME OF THE TABLE WE CREATED IN SCRIPT "04_create_weekly_correlation.sql" !!!
        )
